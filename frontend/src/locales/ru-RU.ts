export default {
    ...
    control: {
        ...
        unlockControls: 'Разблокировать управление',
        lockControls: 'Заблокировать управление',
        controlsLocked: 'Разблокируйте управление воспроизведением, чтобы использовать этот элемент управления.',
