export default {
    ...
    control: {
        ...
        unlockControls: 'Desbloquear controles',
        lockControls: 'Bloquear controles',
        controlsLocked: 'Desbloqueie os controles de playout para usar este controle.',
    ...
    config: {
        ...
        outputMetadata: 'Metadados da saída',
        outputMetadataHelp:
            'Tags globais do contêiner, como title, copyright, service_name e service_provider. O suporte depende do formato de saída.',
        metadataKey: 'Chave dos metadados',
        metadataValue: 'Valor',
